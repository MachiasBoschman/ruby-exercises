...
The Odin Project — Ruby course, *Object Oriented Programming Basics* (project 6 of 15).

- Lesson: <https://www.theodinproject.com/lessons/ruby-mastermind>
- Source: [`ruby/object_oriented_programming_basics/project_mastermind.md`](https://github.com/TheOdinProject/curriculum/blob/2efc3daa345132680746f4a8a56a3abe535fd1eb/ruby/object_oriented_programming_basics/project_mastermind.md)
