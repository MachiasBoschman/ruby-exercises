...
The Odin Project — Ruby course, *Advanced Ruby* (project 8 of 15).

- Lesson: <https://www.theodinproject.com/lessons/ruby-custom-enumerables>
- Source: [`ruby/advanced_ruby/project_custom_enumerables.md`](https://github.com/TheOdinProject/curriculum/blob/2efc3daa345132680746f4a8a56a3abe535fd1eb/ruby/advanced_ruby/project_custom_enumerables.md)
