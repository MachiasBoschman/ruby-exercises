...
The Odin Project — Ruby course, *A Bit of Computer Science* (project 13 of 15).

- Lesson: <https://www.theodinproject.com/lessons/ruby-binary-search-trees>
- Source: [`ruby/computer_science/project_binary_search_trees.md`](https://github.com/TheOdinProject/curriculum/blob/2efc3daa345132680746f4a8a56a3abe535fd1eb/ruby/computer_science/project_binary_search_trees.md)
