...
The Odin Project — Ruby course, *Testing Ruby with RSpec* (project 9 of 15).

- Lesson: <https://www.theodinproject.com/lessons/ruby-connect-four>
- Source: [`ruby/testing_ruby_with_rspec/project_connect_four.md`](https://github.com/TheOdinProject/curriculum/blob/2efc3daa345132680746f4a8a56a3abe535fd1eb/ruby/testing_ruby_with_rspec/project_connect_four.md)
